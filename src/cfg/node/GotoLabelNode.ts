...
import { LabelDecl } from "@specs-feup/clava/api/Joinpoints.js";
import ControlFlowNode from "@specs-feup/flow/flow/ControlFlowNode";
import Node from "@specs-feup/flow/graph/Node";

namespace GotoLabelNode {
    export const TAG = "__clava_flow__goto_label_node";
    ...
    export const TypeGuard = Node.TagTypeGuard<Data, ScratchData>(
        ...
        (sData) => {
            return (
                ...
                sData[ClavaNode.TAG].jp instanceof LabelDecl
            );
        },
    );
